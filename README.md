...
- [docs/BETA_STAGING_PLAN.md](./docs/BETA_STAGING_PLAN.md): what should happen after alpha, how beta differs from MVP, and the exit criteria for a controlled family test phase
