            ...
            <div style={{ background: "linear-gradient(135deg, #1e1470, #2a1060)", padding: "20px 20px 16px", position: "relative" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 12 }}>
                <div style={{ position: "relative", flexShrink: 0 }}>
                  ...
                  <div style={{ position: "absolute", bottom: -4, right: -4, width: 22, height: 22, borderRadius: 8, background: C.violet, color: "#fff", fontSize: 10, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #100b2e" }}>K1</div>
                </div>
                <div style={{ flex: 1, paddingTop: 2 }}>
                  <div style={{ fontSize: 20, fontWeight: 900, color: "#fff", marginBottom: 2 }}>Maya</div>
                  <div style={{ display: "inline-block", background: "rgba(155,114,255,0.25)", border: "1px solid #9b72ff", borderRadius: 8, padding: "2px 9px", fontSize: 11, fontWeight: 700, color: "#c4b0ff", marginBottom: 4 }}>K–1 Band</div>
                  <div style={{ fontSize: 11, color: C.muted }}>Cosmic Castle · Node 8</div>
                </div>
              ...
              <div style={{ display: "flex", background: "rgba(0,0,0,0.2)", borderRadius: 10, overflow: "hidden" }}>
                {[["⭐ 42", "Stars"], ["🔥 5", "Streak"], ["8", "Skills"], ["2", "Badges"]].map(([val, lbl]) => (
