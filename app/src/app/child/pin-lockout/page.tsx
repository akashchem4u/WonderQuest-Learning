          ...
          <>
            ...
            <button
              ...
              style={{
                ...
                color: "#0a2a15", fontSize: 16, fontWeight: 700, cursor: "pointer",
...
export default function PinLockoutPage() {
  return (
    <AppFrame audience="kid">
      <Suspense fallback={
        <div style={{
          minHeight: "100vh", background: "#100b2e",
          display: "flex", alignItems: "center", justifyContent: "center",
          color: "#9b72ff", fontSize: 18, fontFamily: "system-ui",
        }}>
          🔒 Loading…
        </div>
      }>
