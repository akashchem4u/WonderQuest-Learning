...
const BANNER_DATA: Record<
  BannerVariant,
  {
    ...
    showStarSafe: boolean;
    starSafeText: string;
    mobileSubColor: string;
    mobileSub: string;
    mobileCta: string;
    mobileCtaBg: string;
...
> = {
  same: {
    mascot: "🦋",
    greeting: "Welcome back, Zara! ✨",
    sub: "You were just here — Crystal Caverns is waiting at Node 7!",
    ctaText: "Continue →",
    subColor: "#b8a0e8",
    ctaBg: "#9b72ff",
    ctaColor: "#fff",
    ...
    mobileSub: "Crystal Caverns · Node 7 ready",
    mobileCta: "Go →",
    mobileCtaBg: "#9b72ff",
    mobileCtaColor: "#fff",
  ...
  two: {
    mascot: "🦁",
    greeting: "Zara is back! 🚀",
    sub: "Your world is waiting — Crystal Caverns, Node 7, right where you left it!",
    ctaText: "Jump In →",
    subColor: "#d4a060",
    ctaBg: "#f0a030",
    ctaColor: "#1a0800",
    ...
    chips: [],
    showStarSafe: true,
    starSafeText: "⭐ Your 42 stars are safe — always!",
    mobileSubColor: "#d4a060",
    mobileSub: "⭐ Stars safe · Node 7 waiting",
    mobileCta: "Go →",
    mobileCtaBg: "#f0a030",
  ...
  seven: {
    ...
    borderColor: "#2a6048",
    chips: [
      { label: "⭐ +1 star", variant: "gold" },
      { label: "✨ +30 XP", variant: "green" },
      { label: "🔥 Streak restored!", variant: "violet" },
    ],
    showStarSafe: true,
    starSafeText: "⭐ All 42 stars kept safe while you were away!",
  ...
  thirty: {
    mascot: "🏆",
    greeting: "LEGENDARY COMEBACK, ZARA! 🎉",
    ...
    showStarSafe: true,
    starSafeText: "⭐ Every single star you ever earned is still here — all 42!",
    mobileSubColor: "#f0c080",
    mobileSub: "+2⭐ +100XP · 44 stars!",
    mobileCta: "Go →",
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 16px 6px", fontSize: 11, fontWeight: 700, color: "#9b72ff" }}>
              ...
              <span>
                {variant === "same" ? "⭐ 42 🔥 5" : variant === "two" ? "⭐ 42" : variant === "seven" ? "⭐ 43" : "⭐ 44"}
              </span>
              <span>94%</span>
            </div>
            <div style={{
