...
const sectionNav = {
  parent: [
    ...
    { href: "/parent/quiz-review",    label: "Quiz Review",    icon: "🔍" },
      ...
      <div className={`adult-shell theme-${audience}`}>
        ...
        <aside className="adult-sidebar">
          ...
          <div className="adult-sidebar-footer">
            ...
            {audience === "owner" && (
              <a href="/api/admin/logout" className="adult-sidebar-switch" style={{ marginTop: 8, color: "rgba(255,255,255,0.35)", fontSize: "0.75rem" }}>
                Sign out →
              </a>
            )}
          </div>
